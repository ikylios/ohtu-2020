...
public class Stepdefs {
    ...
    @When("a correct username {string} and password {string} and password confirmation {} are entered")
    public void correctUsernameAndCorrectPasswordAndIncorrectPasswordConfirmationAreGiven(String username, String password, String passwordConfirmation) {
    ...
    public void nonexistentUsernameAndNonexistantPasswordAreGiven(String username, String password) throws Throwable {
        logInWith(username, password);
    }   
